...
export function DashSnake() {
    ...
    return (
        <div className="relative">
            ...
            {/* Expanded: Game panel - fixed and centered on mobile */}
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 md:bg-transparent md:absolute md:inset-auto md:bottom-full md:right-0 md:mb-2">
                    <div className="bg-black/95 border border-white/10 rounded-lg p-3 shadow-2xl">
